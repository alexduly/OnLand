...
from qgis._core import QgsRectangle, QgsVectorDataProvider
...
# fmt: off
# fmt off /on prevents autopep moving this code, it needs to be called here otherwise "app not initialized" error gets printed
import processing
...
input_layer_path = "data/input/realworld.shp"


input_layer = QgsVectorLayer(
    input_layer_path, baseName="InputLayer", providerLib="ogr")
